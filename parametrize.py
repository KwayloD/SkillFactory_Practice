...
@pytest.mark.parametrize("x", [1, 2, 3], ids=["negative", "zero", "positive"])
@pytest.mark.parametrize("y", [10, 11], ids=["3 digit", "4 digit"])
...
#27.1.4
#Решим следующую задачу: напишите функцию, которая определяет, можно ли составить треугольник из трёх отрезков, длины которых передаются в функцию.
